...
const int PieceDirection[13][8] = {
    ...
    {-9, -11, 11, 9, 0, 0, 0, 0},     {-1, -10, 1, 10, 0, 0, 0, 0}, {-1, -10, 1, 10, -9, -11, 11, 9},
    {-1, -10, 1, 10, -9, -11, 11, 9}, {0, 0, 0, 0, 0, 0, 0, 0},     {-8, -19, -21, -12, 8, 19, 21, 12},
    {-9, -11, 11, 9, 0, 0, 0, 0},     {-1, -10, 1, 10, 0, 0, 0, 0}, {-1, -10, 1, 10, -9, -11, 11, 9},
    {-1, -10, 1, 10, -9, -11, 11, 9}};
                ...
                while (!SQUAREOFFBOARD(t_square)) {
                    if (position->pieces[t_square] != EMPTY) {
                        if (PieceColour[position->pieces[t_square]] == (side ^ 1)) {
                            AddCaptureMove(position, MOVE_M(square, t_square, position->pieces[t_square], EMPTY, 0),
                                           list);
                        }
                        break;
                    }
